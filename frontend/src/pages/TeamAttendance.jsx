...
import { useGetTeamAttendanceQuery } from '../features/api/attendanceApi';
...
export default function TeamAttendance() {
  ...
  const { data, isLoading } = useGetTeamAttendanceQuery(range);
  ...
  return (
    <div>
      <h1 style={{ marginBottom: 20 }}>Team Attendance</h1>
      ...
      {isLoading ? (
        ...
        <DataTable
          columns={columns}
          rows={data?.records || []}
          emptyLabel="No attendance records found for your team."
